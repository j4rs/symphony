defmodule SymphonyElixir.TestSupport do
  ...
  defp workflow_content(overrides) do
    config =
      Keyword.merge(
        [
          ...
          codex_workspace_writable_subpaths: nil,
    ...
    codex_workspace_writable_subpaths = Keyword.get(config, :codex_workspace_writable_subpaths)
    ...
    sections =
      [
        ...
        if(codex_workspace_writable_subpaths,
          do: "  workspace_writable_subpaths: #{yaml_value(codex_workspace_writable_subpaths)}"
        ),
